...
export interface Photo {
  ...
  what: string;
  use: PhotoUse;
  /** 세로가 긴 사진인지. 4:5 판에서 잘림을 예상할 때 참고 */
  portrait?: boolean;
}
...
export const PHOTOS: Photo[] = [
  ...
  { id: "09", what: "인물 둘이 함께 찍은 사진", use: "life", portrait: true },
  { id: "10", what: "강의실을 가득 채운 수강생 단체 사진 — 손을 흔들고 있다", use: "teaching" },
  { id: "11", what: "강의실 단체 사진 — 박수 치는 수강생들", use: "teaching" },
  ...
  { id: "17", what: "시술 결과 눈매 클로즈업 — 결이 살아있는 자연스러운 컬", use: "result" },
  { id: "18", what: "LED 램프를 눈 위에 대고 있는 시술 장면", use: "craft" },
  { id: "19", what: "사람들과 둘러앉은 식사 자리", use: "life" },
